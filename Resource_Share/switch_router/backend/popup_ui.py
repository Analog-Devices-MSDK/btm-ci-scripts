...
class Ui_login_popup(object):
    def setupUi(self, login_popup):
        if not login_popup.objectName():
            login_popup.setObjectName(u"login_popup")
        ...
        self.inp_ipAddress.setObjectName(u"inp_ipAddress")
    ...
    def retranslateUi(self, login_popup):
        login_popup.setWindowTitle(QCoreApplication.translate("login_popup", u"Form", None))
        self.loginButton.setText(QCoreApplication.translate("login_popup", u"Login", None))
        self.label.setText(QCoreApplication.translate("login_popup", u"IP Address", None))
        self.label2.setText(QCoreApplication.translate("login_popup", u"Password", None))
        self.label_3.setText(QCoreApplication.translate("login_popup", u"Username", None))
    # retranslateUi
